...
assert.equal(fn('1_234_567'), 1234567);
assert.equal(fn("   "), 0);
assert.equal(fn("0"), 0);
...
assert.equal(fn("123"), 123);
assert.equal(fn(" 123"), 123);
assert.equal(fn("0xff"), 255);
assert.equal(fn("0777"), 777);
assert.equal(fn("-0777"), -777);
assert.equal(fn("+123"), 123);
assert.equal(fn("123."), 123);
assert.equal(fn("0.1"), 0.1);
assert.equal(fn(".1"), 0.1);

assert.throws(() => { fn('.') }, "can't convert");
assert.throws(() => { fn('0x') }, "can't convert");
assert.throws(() => { fn('0xt') }, "can't convert");
