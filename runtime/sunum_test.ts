...
round(n(123456, -7), -1, 0, 10, 0);
round(n(123456, -7), 2, .01, .02, .01);
round(n(123456, -5), -2, 0, 100, 0);
round(n(123456, -5), 2, 1.23, 1.24, 1.23);
round(n(123456, -5), 6, 1.23456, 1.23456, 1.23456);
round(n(123456, 1), -2, 1234600, 1234600, 1234500);
round(n(123456, 1), 2, 1234560, 1234560, 1234560);

// log10 -------------------------------------------------------------------------
eq(SuNum.log10(n(-1)), 0);
eq(SuNum.log10(n(10)), 1);
eq(SuNum.log10(n(1, -2)), -2);
eq(SuNum.log10(n(123, -1)), 1.089905111439398);
eq(SuNum.log10(n(0)), '-inf');
eq(SuNum.log10(SuNum.INF), 'inf');
